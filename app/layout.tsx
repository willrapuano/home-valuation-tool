...
export const metadata: Metadata = {
  ...
  description: "Get an instant home value estimate for your Northern Virginia property, based on public property data. Free, fast, no obligation.",
  openGraph: {
    title: "What's My Home Worth?",
    description: "Get your instant home value estimate, based on public property data.",
